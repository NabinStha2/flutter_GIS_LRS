                            ...
                            Column(
                              children: [
                                ...
                                CustomButton.elevatedButton(
                                  "See on map",
                                  () {
                                    _.individualLandResult?.polygon
                                                ?.isNotEmpty ??
                                            false
                                        ? navigate(
                                            context,
                                ...
                                children: [
                                  Text.rich(
                                    TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text: _.individualLandResult?.city ??
                                              "",
                                          style: TextStyle(
                                            color: AppColors.kHeadingColor,
                                            fontWeight: FontWeight.w400,
                                ...
                                children: [
                                  Text.rich(
                                    TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text: _.individualLandResult?.area ??
                                              "",
                                          style: TextStyle(
                                            color: AppColors.kHeadingColor,
                                            fontWeight: FontWeight.w400,
                            ...
                            children: [
                              TextSpan(
                                text: DateFormat('d MMM, yyyy h:mm a')
                                    .format(_.individualLandResult!.createdAt!),
                                style: TextStyle(
                                  color: AppColors.kHeadingColor,
                                  fontWeight: FontWeight.w400,
                                ),
                        ...
                        Row(
                          ...
                          children: [
                            _.individualLandResult?.ownerUserId?.imageFile
                                ...
                                ? ClipRRect(
                                    ...
                                    child: CustomNetworkImage(
                                      imageUrl: _.individualLandResult
                            ...
                            Column(
                              ...
                              children: [
                                CustomText.ourText(
                                  _.individualLandResult?.ownerUserId?.name ??
                                      "",
                                  fontSize: 18,
                                ...
                                vSizedBox2,
                                CustomText.ourText(
                                  _.individualLandResult?.ownerUserId?.email ??
                                      "",
                                  fontSize: 12,
                                  fontWeight: FontWeight.w500,
                                ),
                                ...
                                () {
                                  Provider.of<LandProvider>(context,
                                      ...
                                      .addSaleLand(
                                          context: context,
                                          landRequestModel: LandRequestModel(
                                            landId: _.individualLandResult?.id,
                                          ));
                                },
                              )
                            : AppSharedPreferences.getUserId ==
