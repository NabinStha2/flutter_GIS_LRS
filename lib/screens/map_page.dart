...
ValueNotifier<List<List<LatLng>>> latlngList =
        ...
        builder: (context, _, child) => Stack(
          children: [
            FlutterMap(
              ...
              options: MapOptions(
                onPointerHover:
                    (PointerHoverEvent pointerHoverEvent, LatLng location) {
                ...
                IndexedStack(
                  ...
                  children: [
                    ...
                    TileLayer(
                      ...
                      retinaMode:
                          true && MediaQuery.of(context).devicePixelRatio > 1.0,
                      tileBuilder: (context, _, tile) => CustomText.ourText(
