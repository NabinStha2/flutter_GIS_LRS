...
IndividualLandResponseModel individualLandResponseModelFromJson(String str) => IndividualLandResponseModel.fromJson(json.decode(str));

String individualLandResponseModelToJson(IndividualLandResponseModel data) => json.encode(data.toJson());
...
class IndividualLandResponseModel {
    ...
    factory IndividualLandResponseModel.fromJson(Map<String, dynamic> json) => IndividualLandResponseModel(
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        landData: json["landData"] == null ? null : IndividualLandData.fromJson(json["landData"]),
    );
...
class IndividualLandData {
    ...
    factory IndividualLandData.fromJson(Map<String, dynamic> json) => IndividualLandData(
        id: json["_id"],
        city: json["city"],
        area: json["area"],
        polygon: json["polygon"] == null ? [] : List<Polygon>.from(json["polygon"]!.map((x) => Polygon.fromJson(x))),
        ...
        ownerUserId: json["ownerUserId"] == null ? null : OwnerUserId.fromJson(json["ownerUserId"]),
        ownerHistory: json["ownerHistory"] == null ? [] : List<dynamic>.from(json["ownerHistory"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "city": city,
        "area": area,
        "polygon": polygon == null ? [] : List<dynamic>.from(polygon!.map((x) => x.toJson())),
        "parcelId": parcelId,
        "wardNo": wardNo,
        "district": district,
        "address": address,
        ...
        "ownerHistory": ownerHistory == null ? [] : List<dynamic>.from(ownerHistory!.map((x) => x)),
...
class OwnerUserId {
    ...
    factory OwnerUserId.fromJson(Map<String, dynamic> json) => OwnerUserId(
        ...
        isVerified: json["isVerified"],
        ownedLand: json["ownedLand"] == null ? [] : List<String>.from(json["ownedLand"]!.map((x) => x)),
        name: json["name"],
        createdAt: json["createdAt"] == null ? null : DateTime.parse(json["createdAt"]),
        updatedAt: json["updatedAt"] == null ? null : DateTime.parse(json["updatedAt"]),
        v: json["__v"],
